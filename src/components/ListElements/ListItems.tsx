...
const ListItems = ({ listItem, deleteTask }: ListItemProps) => {
  ...
  return (
    <div>
      {editState ? (
          <div className="h-12 flex basis-2/5 font-mukta text-cyan-700">
            <input
              required
              title="Save Task"
              type="text"
              ...
              className="w-2/5 ml-1 mr-2 px-2 overflow-x-auto placeholder:text-sm placeholder:font-semibold placeholder:bg-gray-200 placeholder:focus:text-transparent"
            />
        
          <div className="flex">
            <span className="flex justify-center flex-row mr-2">
              <button
                type="button"
              ...
              >
                <svg
                  ...
                  className="h-5 w-5 text-purple-800 hover:scale-[115%] disabled:hover:text-gray-500"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
              ...
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 text-red-600 hover:scale-[115%]"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
            ...
            <span className="flex">
              <input
                ...
                value={newDeadline}
                onChange={handleChange}
                className="w-2/5 text-center mr-2 rounded-lg"
              />
              <Listbox
              editState={editState} 
              value={newPeriod} 
          ...
          <div title="rightside" className="justify-between w-46">
            <span className="bg-orange-200/50 text-purple-800 mr-4">
              <button title="Edit Task" onClick={handleEdit}>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="h-5 w-5 mr-2 text-black hover:scale-[115%]"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  stroke-width="2"
              ...
              <button
                title="Delete Task"
                onClick={() => deleteTask?.(listItem.task)}
              >
                <svg
                  className="w-5 h-5 hover:text-red-800 hover:scale-[115%]"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                  xmlns="http://www.w3.org/2000/svg"
                >
